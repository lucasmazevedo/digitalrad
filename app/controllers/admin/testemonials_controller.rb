class Admin::TestemonialsController < AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @testemonial.save
        format.html { redirect_to [:admin, @testemonial], notice: 'Testemonial was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @testemonial.update(testemonial_params)
        format.html { redirect_to [:admin, @testemonial], notice: 'Testemonial was successfully updated.' }
  ...
  def destroy
    @testemonial.destroy
    respond_to do |format|
      format.html { redirect_to admin_testemonials_url, notice: 'Testemonial was successfully destroyed.' }
  ...
  private
    ...
    def testemonial_params
      params.require(:testemonial).permit(:name, :organization, :description, :avatar, :status)
    end
end
